...
var converter = new CSV2JSON_1["default"]('Name,make,modle,id,capacity,\rNanu ,Philip,g15,123,small,\rNanu1,phlio,g16,224,midum');
//converter.setCSV('Name,make,modle,id,capacity,\rNanu ,Philip,g15,123,small,\rNanu1,phlio,g16,224,midum');
var doProcess = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, converter.convert()];
            case 1:
                _a.sent();
